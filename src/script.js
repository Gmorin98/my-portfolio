...
console.log(galaxyVertexShader);
console.log(galaxyFragmentShader);
...
const generateGalaxy = () =>
{
  ...
  for(let i = 0; i < parameters.count; i++) {
    ...
    positions[i3    ] = Math.cos(branchAngle) * radius + randomX  // X axes
    positions[i3 + 1] = randomY                                   // Y axes
    positions[i3 + 2] = Math.sin(branchAngle) * radius + randomZ  // Z axes
